...
class Device(ModbusDevice):
    ...
    def loadDatapoints(self):
        ...
        self.Datapoints[GROUP_COMMANDS] = {
            ...
            "Ventilation control mode": ModbusDatapoint(address=5310, entity_data=EntityDataSelect(options={0: "Normal", 1: "PA Supply control", 2: "PA Extract control", 3: "PA contro", 4: " l/s control"},enabledDefault=False)), #Available only in units with RH sensor (SW 3.1 -> )
        ...
        self.Datapoints[ModbusDefaultGroups.CONFIG] = {
            ...
            "Cooker Hood Home state compensation
            "Cooker Hood Boost state compansation correction
            "Cooker Hood Boost
